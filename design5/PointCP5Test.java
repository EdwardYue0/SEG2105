...
public class PointCP5Test{
  ...
  public static void main(String[] args)
  {
    ...
    try
    {
      //decide which type of point to store
      if(args[0].toUpperCase().charAt(0)=='P'){
        point = new PointCP2(args[0].toUpperCase().charAt(0),Double.valueOf(args[1]).doubleValue(),Double.valueOf(args[2]).doubleValue());

      }

      if(args[0].toUpperCase().charAt(0)=='C'){
        point = new PointCP3(args[0].toUpperCase().charAt(0),Double.valueOf(args[1]).doubleValue(),Double.valueOf(args[2]).doubleValue());
      }
    }
    catch(Exception e)
    {
